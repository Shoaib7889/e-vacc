...
class WorkersMsgs extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className={s.root}>
        <h2 className="page-title">
          Workers - <span className="fw-semi-bold">Messages</span>
        </h2>
        <Row>
          <Col>
            <Widget
              title={
                <h5>
                   <span className="fw-semi-bold">Messages</span>
                </h5>
              }
              settings
              close
